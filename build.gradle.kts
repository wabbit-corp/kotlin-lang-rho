...
// managed-integrity-v1: eRDCcjXVAD
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-lang-rho", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-lang-rho")
        description.set("kotlin-lang-rho")
        url.set("https://github.com/wabbit-corp/kotlin-lang-rho")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-lang-rho")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-lang-rho.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-lang-rho.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-lang-rho"
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-lang-rho/tree/master/src")
