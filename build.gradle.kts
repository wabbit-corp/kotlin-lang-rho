...
kover {
    ...
    //             // title.set("kotlin-lang-rho Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-lang-rho")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-lang-rho/tree/master/src/main/kotlin")
