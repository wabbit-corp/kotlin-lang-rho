...
- Canonical repo target: `kotlin-lang-rho`. Useful entrypoints: `dev project show kotlin-lang-rho`, `dev build kotlin-lang-rho`, `dev check kotlin-lang-rho`.
- Setup-managed files are regenerated with `dev setup kotlin-lang-rho`; avoid hand-editing stamped generated files.
